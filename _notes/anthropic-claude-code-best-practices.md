...
*   [Claude 开发者平台](https://platform.claude.com/)
*   [网页版 Claude Code](https://claude.ai/code)
*   [网页版 Claude Code](https://claude.ai/code)
...
[入门指南](http://www.anthropic.com/docs/en/overview)[使用 Claude Code 构建](http://www.anthropic.com/docs/en/sub-agents)[部署](http://www.anthropic.com/docs/en/third-party-integrations)[管理](http://www.anthropic.com/docs/en/setup)[配置](http://www.anthropic.com/docs/en/settings)[参考](http://www.anthropic.com/docs/en/cli-reference)[Agent SDK](http://www.anthropic.com/docs/en/agent-sdk/overview)[最新动态](http://www.anthropic.com/docs/en/whats-new)[资源](http://www.anthropic.com/docs/en/legal-and-compliance)

##### 入门指南

*   [概述](http://www.anthropic.com/docs/en/overview)
*   [快速开始](http://www.anthropic.com/docs/en/quickstart)
*   [更新日志](http://www.anthropic.com/docs/en/changelog)

##### 核心概念

*   [Claude Code 的工作原理](http://www.anthropic.com/docs/en/how-claude-code-works)
*   [扩展 Claude Code](http://www.anthropic.com/docs/en/features-overview)
*   [探索 .claude 目录](http://www.anthropic.com/docs/en/claude-directory)
*   [探索上下文窗口](http://www.anthropic.com/docs/en/context-window)

##### 使用 Claude Code

*   [存储指令与记忆](http://www.anthropic.com/docs/en/memory)
*   [权限模式](http://www.anthropic.com/docs/en/permission-modes)
*   [常见工作流程](http://www.anthropic.com/docs/en/common-workflows)
*   [最佳实践](http://www.anthropic.com/docs/en/best-practices)

##### 平台与集成

*   [概述](http://www.anthropic.com/docs/en/platforms)
*   [远程控制](http://www.anthropic.com/docs/en/remote-control)
*   网页版 Claude Code  
*   桌面版 Claude Code  
*   [Chrome 扩展（测试版）](http://www.anthropic.com/docs/en/chrome)
*   [计算机使用（预览版）](http://www.anthropic.com/docs/en/computer-use)
*   [Visual Studio Code](http://www.anthropic.com/docs/en/vs-code)
*   [JetBrains IDE](http://www.anthropic.com/docs/en/jetbrains)
*   代码审查与 CI/CD  
*   [Slack 中的 Claude Code](http://www.anthropic.com/docs/en/slack)

本页内容

*   [让 Claude 能够验证自己的工作](http://www.anthropic.com/engineering/claude-code-best-practices#give-claude-a-way-to-verify-its-work)
*   [先探索，再规划，再编码](http://www.anthropic.com/engineering/claude-code-best-practices#explore-first-then-plan-then-code)
*   [在提示词中提供具体上下文](http://www.anthropic.com/engineering/claude-code-best-practices#provide-specific-context-in-your-prompts)
*   [提供丰富的内容](http://www.anthropic.com/engineering/claude-code-best-practices#provide-rich-content)
*   [配置你的环境](http://www.anthropic.com/engineering/claude-code-best-practices#configure-your-environment)
*   [编写有效的 CLAUDE.md](http://www.anthropic.com/engineering/claude-code-best-practices#write-an-effective-claude-md)
*   [配置权限](http://www.anthropic.com/engineering/claude-code-best-practices#configure-permissions)
*   [使用 CLI 工具](http://www.anthropic.com/engineering/claude-code-best-practices#use-cli-tools)
*   [连接 MCP 服务器](http://www.anthropic.com/engineering/claude-code-best-practices#connect-mcp-servers)
*   [设置钩子](http://www.anthropic.com/engineering/claude-code-best-practices#set-up-hooks)
*   [创建技能](http://www.anthropic.com/engineering/claude-code-best-practices#create-skills)
*   [创建自定义子代理](http://www.anthropic.com/engineering/claude-code-best-practices#create-custom-subagents)
*   [安装插件](http://www.anthropic.com/engineering/claude-code-best-practices#install-plugins)
*   [有效沟通](http://www.anthropic.com/engineering/claude-code-best-practices#communicate-effectively)
*   [提问代码库问题](http://www.anthropic.com/engineering/claude-code-best-practices#ask-codebase-questions)
*   [让 Claude 来采访你](http://www.anthropic.com/engineering/claude-code-best-practices#let-claude-interview-you)
*   [管理你的会话](http://www.anthropic.com/engineering/claude-code-best-practices#manage-your-session)
*   [尽早并频繁纠偏](http://www.anthropic.com/engineering/claude-code-best-practices#course-correct-early-and-often)
*   [主动管理上下文](http://www.anthropic.com/engineering/claude-code-best-practices#manage-context-aggressively)
*   [使用子代理进行调查](http://www.anthropic.com/engineering/claude-code-best-practices#use-subagents-for-investigation)
*   [使用检查点回退](http://www.anthropic.com/engineering/claude-code-best-practices#rewind-with-checkpoints)
*   [恢复对话](http://www.anthropic.com/engineering/claude-code-best-practices#resume-conversations)
*   [自动化与扩展](http://www.anthropic.com/engineering/claude-code-best-practices#automate-and-scale)
*   [运行非交互模式](http://www.anthropic.com/engineering/claude-code-best-practices#run-non-interactive-mode)
*   [运行多个 Claude 会话](http://www.anthropic.com/engineering/claude-code-best-practices#run-multiple-claude-sessions)
*   [跨文件并行展开](http://www.anthropic.com/engineering/claude-code-best-practices#fan-out-across-files)
*   [使用自动模式自主运行](http://www.anthropic.com/engineering/claude-code-best-practices#run-autonomously-with-auto-mode)
*   [避免常见失败模式](http://www.anthropic.com/engineering/claude-code-best-practices#avoid-common-failure-patterns)
*   [培养你的直觉](http://www.anthropic.com/engineering/claude-code-best-practices#develop-your-intuition)
*   [相关资源](http://www.anthropic.com/engineering/claude-code-best-practices#related-resources)
...
关于如何充分利用 Claude Code 的技巧与模式，涵盖环境配置到跨并行会话的规模化使用。

复制页面

Claude Code 是一个具有代理能力的编码环境。与那种回答问题然后等待的聊天机器人不同，Claude Code 能够读取你的文件、运行命令、进行修改，并在你观察、引导或完全离开的情况下自主解决问题。这改变了你的工作方式。你不再需要自己编写代码后让 Claude 来审查，而是描述你想要什么，由 Claude 来决定如何构建。Claude 会自主探索、规划并实现。但这种自主性仍然有一条学习曲线。Claude 在某些你需要理解的约束条件下工作。本指南涵盖了在 Anthropic 内部团队以及在各种代码库、语言和环境中使用 Claude Code 的工程师中被证明有效的模式。关于代理循环在底层的工作原理，请参阅 [Claude Code 的工作原理](http://www.anthropic.com/docs/en/how-claude-code-works)。
...
[子代理](http://www.anthropic.com/docs/en/sub-agents)在各自的上下文中运行，并拥有各自允许使用的工具集。它们适用于需要读取大量文件或需要专项聚焦、又不希望占用主会话上下文的任务。
...
明确告知 Claude 使用子代理：_"使用子代理来审查此代码的安全问题。"_
...
[插件](http://www.anthropic.com/docs/en/plugins)将技能、钩子、子代理和 MCP 服务器打包成单一可安装单元，来源于社区和 Anthropic。如果你使用的是强类型语言，请安装[代码智能插件](http://www.anthropic.com/docs/en/discover-plugins#code-intelligence)，为 Claude 提供精确的符号导航以及编辑后的自动错误检测。关于如何在技能、子代理、钩子和 MCP 之间做出选择，请参阅[扩展 Claude Code](http://www.anthropic.com/docs/en/features-overview#match-features-to-your-goal)。
...
使用 `"use subagents to investigate X"` 委托研究任务。子代理在独立的上下文中进行探索，让你的主对话保持整洁，专注于实现。

由于上下文是你的根本限制，子代理是最强大的工具之一。当 Claude 研究代码库时，它会读取大量文件，这些文件都会消耗你的上下文。子代理在独立的上下文窗口中运行，并以摘要的形式汇报结果：
...
子代理探索代码库、读取相关文件，并汇报发现结果，整个过程不会污染你的主对话。你也可以在 Claude 实现某些功能后，使用子代理进行验证：
...
*   [代理团队](http://www.anthropic.com/docs/en/agent-teams)：自动协调多个会话，支持共享任务、消息传递和团队负责人。
...
> **解决方案**：缩小调查范围，或使用子代理，以免探索消耗主要上下文。
...
*   [Claude Code 工作原理](http://www.anthropic.com/docs/en/how-claude-code-works)：代理循环、工具和上下文管理
*   [扩展 Claude Code](http://www.anthropic.com/docs/en/features-overview)：技能、钩子、MCP、子代理和插件
...
[常见工作流程](http://www.anthropic.com/docs/en/common-workflows)[概览](http://www.anthropic.com/docs/en/platforms)

⌘I

[Claude Code 文档主页![图片 4: 浅色 logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/light.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=78fd01ff4f4340295a4f66e2ea54903c)![图片 5: 深色 logo](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/logo/dark.svg?fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=1298a0c3b3a1da603b190d0de0e31712)](http://www.anthropic.com/docs/en/overview)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

公司

[Anthropic](https://www.anthropic.com/company)[招聘](https://www.anthropic.com/careers)[经济未来](https://www.anthropic.com/economic-futures)[研究](https://www.anthropic.com/research)[新闻](https://www.anthropic.com/news)[信任中心](https://trust.anthropic.com/)[透明度](https://www.anthropic.com/transparency)

帮助与安全

[可用性](https://www.anthropic.com/supported-countries)[状态](https://status.anthropic.com/)[支持中心](https://support.claude.com/)

学习

[课程](https://www.anthropic.com/learn)[MCP 连接器](https://claude.com/partners/mcp)[客户案例](https://www.claude.com/customers)[工程博客](https://www.anthropic.com/engineering)[活动](https://www.anthropic.com/events)[由 Claude 驱动](https://claude.com/partners/powered-by-claude)[服务合作伙伴](https://claude.com/partners/services)[初创企业计划](https://claude.com/programs/startups)

条款与政策

[隐私选择](http://www.anthropic.com/engineering/claude-code-best-practices#)[隐私政策](https://www.anthropic.com/legal/privacy)[披露政策](https://www.anthropic.com/responsible-disclosure-policy)[使用政策](https://www.anthropic.com/legal/aup)[商业条款](https://www.anthropic.com/legal/commercial-terms)[消费者条款](https://www.anthropic.com/legal/consumer-terms)
