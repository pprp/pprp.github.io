...
这一系统从原型到生产的历程，让我们更清楚地看到系统架构、工具设计和提示词工程的关键原则。多智能体系统由多个智能体协同工作组成：每个智能体本质上都是一个在循环中自主使用工具的大语言模型。Claude Research 中的主智能体会根据用户查询规划研究流程，再创建并行子智能体去搜索不同方向的信息。与此同时，多智能体系统也会带来新的挑战：协调、评估和可靠性都变得更难。
