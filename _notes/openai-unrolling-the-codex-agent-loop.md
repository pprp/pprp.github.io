...
首先，我们将聚焦于 _智能体循环_。它是 Codex CLI 的核心逻辑，负责协调用户、模型，以及模型为执行任务所调用的工具。理解这一循环，才能理解所谓“harness”真正发挥作用的地方。
...
- [使用 API 密钥对 OpenAI 托管模型进行身份验证时，会使用 ](https://github.com/openai/codex/blob/d886a8646cb8d3671c3029d08ae8f13fa6536899/codex-rs/core/src/model_provider_info.rs#L143)`https://api.openai.com/v1/responses` 作为端点
