...
title_en: 'LLM Quantization: Principles, Frontiers and Practice'
date: 2025-08-05 11:00:00 +0800
last_modified_at: 2026-04-27 00:00:00 +0800
author: pprp
categories: tech
topics: [model-compression, efficient-llm]
excerpt: '从量化误差与数值表示出发，系统梳理 PTQ、QAT、混合精度和 QLoRA，并给出大语言模型压缩与部署的实践路径。'
---
{::nomarkdown}
    <meta charset="UTF-8"/>
  ...
  <body class="bg-base-100">
    ...
    <main class="main-content">
      ...
      <section id="introduction" class="py-16 bg-base-200">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">真正的瓶颈不是模型太聪明，而是模型太重</h2>

            <div class="prose prose-lg max-w-none">
              <p class="text-lg leading-relaxed mb-6">
                大型语言模型的能力越强，部署时遇到的第一个现实问题往往越朴素：显存不够、延迟太高、成本压不下来。量化技术要解决的正是这个矛盾。它不是让模型“变小”这么简单，而是在数值精度、计算效率和任务质量之间重新分配预算。
              </p>

              <p class="text-lg leading-relaxed mb-6">
                从技术上看，大型语言模型（LLM）的量化是一种通过降低模型参数数值精度来减小模型尺寸、加速推理并降低内存占用的关键技术。它通过将高精度浮点数（如FP32）映射到低精度整数（如INT8、INT4），在尽量控制模型性能损失的前提下，实现显著的效率提升 <a href="https://www.tensorops.ai/post/what-are-quantized-llms" class="citation-link" target="_blank">[1]</a>。
              </p>
              ...
              <div class="highlight-box">
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 class="font-semibold text-neutral mb-2">量化真正改变的是部署门槛</h3>
              ...
              <p class="mb-6">
                因此，讨论量化不能只问“能压到几位”，还要问“压缩之后还能不能完成目标任务”。主流的量化技术包括GPTQ、AWQ和QLoRA，它们分别适用于不同的场景：GPTQ和AWQ是高效的后训练量化（PTQ）方法，适用于快速部署；而QLoRA则是一种结合量化的微调技术，适用于在消费级硬件上对大型模型进行定制化训练 <a href="https://www.digitalocean.com/community/tutorials/model-quantization-large-language-models" class="citation-link" target="_blank">[4]</a>。
              </p>
      ...
      <section id="principles" class="py-16">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">量化的本质：用可控误差换部署空间</h2>
      ...
      <section id="performance" class="py-16 bg-base-200">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">评估量化效果，要同时看精度、延迟与显存</h2>
      ...
      <section id="techniques" class="py-16">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">不同量化路线，解决的是不同部署问题</h2>
                  ...
                  <div>
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg">
                      <p class="text-sm text-purple-800">
                        使得在单个48GB GPU上对65B参数的模型进行微调成为可能，显著降低了大型模型微调的门槛 <a href="https://arxiv.org/html/2402.16775v1" class="citation-link text-purple-700" target="_blank">[278]</a>。
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section id="bitsandbytes" class="py-16 bg-base-200">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">从原理到落地：用bitsandbytes降低显存压力</h2>
...
model_lora.print_trainable_parameters()</code></pre>
      ...
      <section id="awq" class="py-16">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">AWQ的落地关键：保护真正敏感的权重通道</h2>
...
tokenizer.save_pretrained(&#34;./llama-2-7b-awq&#34;)</code></pre>
    ...
    def forward(self, x):
      ...
      <section id="conclusion" class="py-16 bg-base-200">
        <div class="container mx-auto px-4 md:px-8">
          <div class="max-w-4xl mx-auto">
            <h2 class="font-serif-sc text-3xl font-bold text-neutral mb-8">量化不是终点，而是模型工程化的入口</h2>

            <div class="space-y-8">
              <div class="bg-white rounded-xl p-8 shadow-lg">
                <h3 class="font-serif-sc text-xl font-semibold text-neutral mb-6">技术总结：成本底线与能力上限要一起看</h3>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul class="space-y-3 text-sm text-neutral-content">
                      ...
                      <li class="flex items-start space-x-2">
                        <i class="fas fa-check-circle text-green-500 mt-1"></i>
                        <span><strong>QLoRA：</strong>结合量化与低秩适配，让大型模型定制更接近普通开发环境</span>
                      </li>
                      <li class="flex items-start space-x-2">
                        <i class="fas fa-check-circle text-green-500 mt-1"></i>
              ...
              <div class="bg-white rounded-xl p-8 shadow-lg">
                <h3 class="font-serif-sc text-xl font-semibold text-neutral mb-6">未来展望：低比特、硬件协同与任务适配</h3>
              ...
              <div class="text-center py-12">
                <div class="max-w-2xl mx-auto">
                  ...
                  <p class="text-lg text-neutral-content mb-8">
                    量化真正改变的不是模型参数表里的数字，而是大模型能否以可接受的成本、延迟和质量进入产品系统。
                  </p>
...
@misc{dong2025quant,
  ...
  month = aug,
  day = {5},
  howpublished = {\url{https://pprp.github.io/tech/Quant/}},
  url = {https://pprp.github.io/tech/Quant/},
