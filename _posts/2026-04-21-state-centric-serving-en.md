...
![Figure 5: Representative public signals about context windows](../../images/state-serving/fig05_context_windows.png)
...
![Figure 6: Product signals of the shift from longer windows to longer service](../../images/state-serving/fig06_service_horizon.png)
...
![Figure 2: KV cache remains a bottleneck at long context lengths](../../images/state-serving/fig02_kv_cache_curve.png)
...
![Figure 1: Route map from long context to state-centric serving](../../images/state-serving/fig01_architecture_landscape.png)
...
![Figure 3: A four-layer memory stack for state-centric serving](../../images/state-serving/fig03_memory_stack.png)
...
![Figure 7: The state-serving loop for long-horizon agents](../../images/state-serving/fig07_state_serving_loop.png)
...
![Figure 8: Evaluation map for state-centric serving](../../images/state-serving/fig08_evaluation_map.png)
...
![Figure 4: Minimal lifecycle from reusable state to possible state artifact economy](../../images/state-serving/fig04_state_market.png)
