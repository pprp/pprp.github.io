...
title_en: 'Reinforcement Learning with Verifiable Rewards (RLVR)'
date: 2025-08-05 11:00:00 +0800
last_modified_at: 2026-04-27 00:00:00 +0800
author: pprp
categories: tech
topics: [reasoning, llm-training]
excerpt: '解释可验证奖励强化学习如何利用数学、代码等可自动检查的反馈训练推理模型，并梳理 GRPO、奖励设计、训练流程与常见风险。'
---
{::nomarkdown}
...
<style>
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid md:grid-cols-3 gap-8">
            <div class="highlight-box">
              ...
              <p class="text-gray-700">使用确定性验证器替代主观人类反馈，使奖励信号更接近客观、可重复的评估。</p>
            </div>
            <div class="highlight-box">
    ...
    <!-- Overview -->
        <section id="overview" class="section-card">
          <h2 class="text-3xl font-bold mb-6">RLVR解决的不是“偏好”，而是“对错”</h2>
    ...
    <!-- Core Concepts -->
        <section id="core-concepts" class="section-card">
          <h2 class="text-3xl font-bold mb-6">核心概念：把奖励锚定在可验证结果上</h2>

    <div id="rlvr-definition" class="mb-8">
            <h3 class="text-2xl font-semibold mb-4">RLVR的动机：减少主观评分链条</h3>
            <p class="mb-4">
    ...
    <div class="highlight-box">
              ...
              <ul class="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>在可验证任务中降低奖励黑客（Reward Hacking）风险</li>
                <li>奖励信号直接与任务目标对齐</li>
    ...
    <div id="rlhf-comparison" class="mb-8">
            <h3 class="text-2xl font-semibold mb-4">RLVR与RLHF：一个优化偏好，一个优化正确性</h3>
    ...
    <!-- Workflow -->
        <section id="workflow" class="section-card">
          <h2 class="text-3xl font-bold mb-6">工作流程：生成、验证、再优化</h2>
    ...
    <!-- GRPO Algorithm -->
        <section id="grpo-algorithm" class="section-card">
          <h2 class="text-3xl font-bold mb-6">核心算法：用组内比较替代独立Critic</h2>

    <div id="grpo-overview" class="mb-8">
            <h3 class="text-2xl font-semibold mb-4">GRPO算法概述：相对优势来自同题多答</h3>
            <p class="mb-4">
    ...
    <div class="highlight-box">
              ...
              <p class="mb-3">GRPO不再训练独立的Critic网络，而是采用一种更直接的方式估计优势：</p>
              <ul class="list-disc list-inside space-y-2 text-gray-700">
    ...
    <!-- Code Implementation -->
        <section id="code-implementation" class="section-card">
          <h2 class="text-3xl font-bold mb-6">代码实战：把验证器接入训练循环</h2>
...
5
    ...
    <!-- Discussion -->
        <section id="discussion" class="section-card">
          <h2 class="text-3xl font-bold mb-6">讨论与展望：可验证任务是优势，也是边界</h2>
